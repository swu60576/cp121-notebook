...
เรื่องของ object ก็ประมาณนี้ เป็น datatype ประเภทหนึ่ง ซึ่งไม่ใช่ primitive เป็นเหมือนกับ datatype ที่เรากำหนดขึ้นมาเอง แน่นอนว่าอะไรอย่าง `bob + alice` คงไม่ได้ให้ค่าอะไรที่เราต้องการแน่ๆ 
