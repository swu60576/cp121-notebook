...
print(i)
```
จะเห็นว่า เรา print `a` ออกมาได้ แต่คอมฟ้องว่า ยังไม่ได้ประกาศ `i` <br >
แต่แน่นอนว่า ก็เหมือนกับ [scope ของ function](https://github.com/swu60576/cp121-notebook/blob/master/2-function.md#function-scope) ไม่ว่าจะเป็น while loop หรือ for loop ถ้าเราประกาศตัวแปรใน scope ของมัน ก็จะเข้าถึงค่าจากข้างนอกไม่ได้ใช่กัน เช่น
```javascript
//while scope
let a = 0
while (a < 5) {
...
print(a)
print(x) // ฟ้องว่า ยังไม่ได้ประกาศ x 
...
print(y) // ฟ้องว่า ยังไม่ได้ประกาศ y
...
//มีความเข้าใจผิดบางอย่างเกี่ยวกับจำนวนครั้งของ loop เกิดขึ้น
for (let i = 0; i < 5; i++) {
print(alpha[i])
}
